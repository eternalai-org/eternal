...
// FindMostVotedDigest is a free data retrieval call binding the contract method 0xb5f255c4.
//
// Solidity: function findMostVotedDigest(uint256 _inferenceId) view returns(bytes32, uint8)
func (_WorkerHub *WorkerHubCaller) FindMostVotedDigest(opts *bind.CallOpts, _inferenceId *big.Int) ([32]byte, uint8, error) {
	var out []interface{}
	err := _WorkerHub.contract.Call(opts, &out, "findMostVotedDigest", _inferenceId)
...
//
// Solidity: function findMostVotedDigest(uint256 _inferenceId) view returns(bytes32, uint8)
func (_WorkerHub *WorkerHubSession) FindMostVotedDigest(_inferenceId *big.Int) ([32]byte, uint8, error) {
	return _WorkerHub.Contract.FindMostVotedDigest(&_WorkerHub.CallOpts, _inferenceId)
}

// FindMostVotedDigest is a free data retrieval call binding the contract method 0xb5f255c4.
//
// Solidity: function findMostVotedDigest(uint256 _inferenceId) view returns(bytes32, uint8)
func (_WorkerHub *WorkerHubCallerSession) FindMostVotedDigest(_inferenceId *big.Int) ([32]byte, uint8, error) {
	return _WorkerHub.Contract.FindMostVotedDigest(&_WorkerHub.CallOpts, _inferenceId)
}
...
// GetFilterCommitment1 is a paid mutator transaction binding the contract method 0xc1612eed.
//
// Solidity: function getFilterCommitment1(uint256 _inferenceId) returns(bool)
func (_WorkerHub *WorkerHubTransactor) GetFilterCommitment1(opts *bind.TransactOpts, _inferenceId *big.Int) (*types.Transaction, error) {
	return _WorkerHub.contract.Transact(opts, "getFilterCommitment1", _inferenceId)
}

// GetFilterCommitment1 is a paid mutator transaction binding the contract method 0xc1612eed.
//
// Solidity: function getFilterCommitment1(uint256 _inferenceId) returns(bool)
func (_WorkerHub *WorkerHubSession) GetFilterCommitment1(_inferenceId *big.Int) (*types.Transaction, error) {
	return _WorkerHub.Contract.GetFilterCommitment1(&_WorkerHub.TransactOpts, _inferenceId)
}

// GetFilterCommitment1 is a paid mutator transaction binding the contract method 0xc1612eed.
//
// Solidity: function getFilterCommitment1(uint256 _inferenceId) returns(bool)
func (_WorkerHub *WorkerHubTransactorSession) GetFilterCommitment1(_inferenceId *big.Int) (*types.Transaction, error) {
	return _WorkerHub.Contract.GetFilterCommitment1(&_WorkerHub.TransactOpts, _inferenceId)
}
...
func (_WorkerHub *WorkerHubSession) Initialize(_l2Owner common.Address, _treasury common.Address, _daoToken common.Address, _feeL2Percentage uint16, _feeTreasuryPercentage uint16, _minerMinimumStake *big.Int, _minerRequirement uint8, _blocksPerEpoch *big.Int, _rewardPerEpoch *big.Int, _submitDuration *big.Int, _commitDuration *big.Int, _revealDuration *big.Int, _unstakeDelayTime *big.Int, _penaltyDuration *big.Int, _finePercentage uint16, _feeRatioMinerValidor uint16, _minFeeToUse *big.Int, _daoTokenReward *big.Int, _daoTokenPercentage IWorkerHubDAOTokenPercentage) (*types.Transaction, error) {
	return _WorkerHub.Contract.Initialize(&_WorkerHub.TransactOpts, _l2Owner, _treasury, _daoToken, _feeL2Percentage, _feeTreasuryPercentage, _minerMinimumStake, _minerRequirement, _blocksPerEpoch, _rewardPerEpoch, _submitDuration, _commitDuration, _revealDuration, _unstakeDelayTime, _penaltyDuration, _finePercentage, _feeRatioMinerValidor, _minFeeToUse, _daoTokenReward, _daoTokenPercentage)
}
