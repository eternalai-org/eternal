...
func main() {
	...
	modelManager := manager.NewModelManager(cfg.ModelsDir, cfg.RPC, cfg.NodeMode, cfg.WorkerHub, cfg.DisableGPU, cfg.ZKSync, cfg.LLM)
...
func AutomaticallyCheckNewVersion(cfg *config.Config) {
